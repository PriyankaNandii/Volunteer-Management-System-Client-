                ...
                <div className="container px-6 py-12 mx-auto">
                    ...
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                        ...
                        {/* <div>
                            ...
                            <div className="flex flex-col items-start mt-5 space-y-2">
                                <a href="#" className=" transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500">Healthcare</a>
                                <a href="#" className=" transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500">ENVIRONMENTAL CONSERVATION
